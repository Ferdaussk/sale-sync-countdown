...
// For woocommerce
function sscdn_WooCommerce_register_required_plugins() {
	...
	if (sscdn_WooCommerce_addon_install()){
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('Sale Sync Countdown').'</b> '.esc_html__('requires WooCommerce to be activated.').'</p>';
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('Sale Sync Countdown').'</b> '.esc_html__('requires WooCommerce to be installed and activated.').'</p>';
...
function sscdn_WooCommerce_addon_install(){
